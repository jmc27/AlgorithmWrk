 ...
 * text file (article title and content, separated by a tab).
 * 
 * @author Jimmy Lin
 * @author Peter Exner
 */
public class DumpWikipediaToPlainText extends Configured implements Tool {
	private static final Logger LOG = Logger
			.getLogger(DumpWikipediaToPlainText.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName(String.format(
				"DumpWikipediaToPlainText[%s: %s, %s: %s, %s: %s]",
		...
		JobConf cnf = new JobConf(job.getConfiguration(), job.getClass());
		cnf.setInputFormat(WikipediaPageInputFormat.class);
